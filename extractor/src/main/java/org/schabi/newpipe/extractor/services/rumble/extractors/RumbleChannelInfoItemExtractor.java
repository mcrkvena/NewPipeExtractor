...
public class RumbleChannelInfoItemExtractor implements StreamInfoItemExtractor{

    protected final JsonObject item;
    public RumbleChannelInfoItemExtractor(final JsonObject json) {
        item = json;
    }
    @Override
    ...
    public String getUrl() throws ParsingException {
        return "https://api.dailymotion.com/user/" + item.getString("id");
    }
    ...
    public long getViewCount() throws ParsingException {
        return item.getLong("views_total");
    }

    @Override
    public String getUploaderName() throws ParsingException {
        return item.getString("screenname");
    }
    ...
    public String getUploaderAvatarUrl() throws ParsingException {
        return item.getObject("owner").getString("avatar_url");
    }
