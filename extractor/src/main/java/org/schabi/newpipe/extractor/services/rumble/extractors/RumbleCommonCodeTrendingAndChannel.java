...
/**
 * shared code for {@link RumbleFeedExtractor} and {@link RumbleChannelExtractor}
 */
public class RumbleCommonCodeTrendingAndChannel {
    ...
    public ListExtractor.InfoItemsPage<StreamInfoItem> extractAndGetInfoItemsFromPage(final Document info)
        ...
        final List<StreamInfoItemExtractor> infoItemsList =
                rumbleCommonCodeTrendingAndSearching.getSearchOrTrendingResultsItemList(info);
        ...
        final Page nextPage = rumbleCommonCodeTrendingAndSearching
                .getNewPageIfThereAreMoreThanOnePageResults(
                        infoItemsList.size(), info, baseUrl + "?page=");
